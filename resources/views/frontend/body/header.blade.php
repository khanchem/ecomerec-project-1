        ...
        <div class="header-top-inner">
          <div class="cnt-account">
            <ul class="list-unstyled">
              <li><a href="{{url('logout')}}"><i class="icon fa fa-user"></i>My Account</a></li>
              <li><a href="#"><i class="icon fa fa-heart"></i>Wishlist</a></li>
              <li><a href="#"><i class="icon fa fa-shopping-cart"></i>My Cart</a></li>
              <li><a href="#"><i class="icon fa fa-check"></i>Checkout</a></li>

              @auth
              <li><a href="{{route('user.profile.view/',Auth::user()->id)}}"><i class="icon fa fa-user"></i>User Profile</a></li>
                @else  
                <li><a href="{{route('register')}}"><i class="icon fa fa-lock"></i>Login/Register</a></li>
              @endauth
